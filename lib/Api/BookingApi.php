...
class BookingApi
{
     ...
     * @return \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\BookingDiffOutputListResourceList
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\BookingDiffOutputListResourceList, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2BookingsDiffGetWithHttpInfo($start_date, $channel_connection_id = null, $end_date = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\KigoPro\Model\BookingDiffOutputListResourceList' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\BookingDiffOutputListResourceList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\KigoPro\Model\BookingDiffOutputListResourceList';
            $responseBody = $response->getBody();
     ...
     */
    protected function channelsV2BookingsDiffGetRequest($start_date, $channel_connection_id = null, $end_date = null)
    {
        ...
        if ($channel_connection_id !== null) {
            $queryParams['ChannelConnectionID'] = ObjectSerializer::toQueryValue($channel_connection_id);
        }
        // query params
        if ($start_date !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsIdCancelPutRequest($id, $cancelled_by_role = null, $cancellation_reason = null)
    {
        ...
        if ($cancelled_by_role !== null) {
            $queryParams['cancelledByRole'] = ObjectSerializer::toQueryValue($cancelled_by_role);
        }
        // query params
        if ($cancellation_reason !== null) {
            $queryParams['cancellationReason'] = ObjectSerializer::toQueryValue($cancellation_reason);
        }
     ...
     * @param  \Piksel\KigoPro\Model\CreditCard $credit_card Credit Card object (optional)
     *
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PostBookingCreditCardResponse
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PostBookingCreditCardResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2BookingsIdCreditcardsPostWithHttpInfo($id, $credit_card = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\KigoPro\Model\PostBookingCreditCardResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\PostBookingCreditCardResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\KigoPro\Model\PostBookingCreditCardResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsIdCreditcardsPostRequest($id, $credit_card = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $id Booking ID (required)
     * @param  \Piksel\KigoPro\Model\BookingEvent $booking_event Booking Event (optional)
     *
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsIdEventsPostRequest($id, $booking_event = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\BookingResource
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\BookingResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2BookingsIdGetWithHttpInfo($id, $options = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\KigoPro\Model\BookingResource' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\BookingResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\KigoPro\Model\BookingResource';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsIdGetRequest($id, $options = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  int $id Booking ID (required)
     * @param  \Piksel\KigoPro\Model\PutBookingRequest $put_booking_request Booking object to be updated (optional)
     *
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PutBookingResponse
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PutBookingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2BookingsIdPutWithHttpInfo($id, $put_booking_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\KigoPro\Model\PutBookingResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\PutBookingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\KigoPro\Model\PutBookingResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsIdPutRequest($id, $put_booking_request = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  \Piksel\KigoPro\Model\PostBookingRequest $post_booking_request Booking object (optional)
     *
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PostBookingResponse
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\ApiError|\Piksel\KigoPro\Model\PostBookingResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2BookingsPostWithHttpInfo($post_booking_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\KigoPro\Model\PostBookingResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\PostBookingResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2BookingsPostRequest($post_booking_request = null)
    {
        ...
        if (isset($post_booking_request)) {
            $_tempBody = $post_booking_request;
        }
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\KigoPro\Model\GetBookingVm
     */
     ...
     * @throws \Piksel\KigoPro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\KigoPro\Model\GetBookingVm, HTTP status code, HTTP response headers (array of strings)
     */
    public function proV1BookingsGetWithHttpInfo($start_date, $account_id = null, $end_date = null, $property_id = null, $channel = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Piksel\KigoPro\Model\GetBookingVm' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\KigoPro\Model\GetBookingVm', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\KigoPro\Model\GetBookingVm';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1BookingsGetRequest($start_date, $account_id = null, $end_date = null, $property_id = null, $channel = null)
    {
        // verify the required parameter 'start_date' is set
        if ($start_date === null || (is_array($start_date) && count($start_date) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1BookingsIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
