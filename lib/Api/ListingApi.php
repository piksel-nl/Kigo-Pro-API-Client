...
class ListingApi
{
     ...
     */
    protected function channelsV2ListingsDiffGetRequest($modified_after, $options = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsGetRequest($cc_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsIdAvailabilityGetRequest($id, $start_date, $end_date)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsIdCheckavailabilityGetRequest($id, $check_in_date, $check_out_date, $num_adults, $num_children = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($check_in_date !== null) {
            $queryParams['CheckInDate'] = ObjectSerializer::toQueryValue($check_in_date);
        }
        // query params
        if ($check_out_date !== null) {
            $queryParams['CheckOutDate'] = ObjectSerializer::toQueryValue($check_out_date);
        }
        // query params
        if ($num_adults !== null) {
            $queryParams['NumAdults'] = ObjectSerializer::toQueryValue($num_adults);
        }
        // query params
        if ($num_children !== null) {
            $queryParams['NumChildren'] = ObjectSerializer::toQueryValue($num_children);
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsIdGetRequest($id, $options = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsIdLospricingCsvGetRequest($id, $start_date, $end_date, $payment_plan_setting_id = null, $options = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($payment_plan_setting_id !== null) {
            $queryParams['paymentPlanSettingID'] = ObjectSerializer::toQueryValue($payment_plan_setting_id);
        }
        // query params
        if (is_array($options)) {
            $options = ObjectSerializer::serializeCollection($options, 'multi', true);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function channelsV2ListingsIdRatesGetRequest($id, $start_date, $end_date, $payment_plan_guid = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($payment_plan_guid !== null) {
            $queryParams['paymentPlanGuid'] = ObjectSerializer::toQueryValue($payment_plan_guid);
        }
