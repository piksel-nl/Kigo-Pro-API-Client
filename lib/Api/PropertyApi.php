...
class PropertyApi
{
     ...
     */
    protected function proV1ContentPropertiesGetRequest($page_num = null, $page_size = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1ContentPropertiesIdPropertysummaryGetRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1ContentPropertiesPagedPageNumGetRequest($page_num2, $page_num = null, $page_size = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1ContentPropertiesPagedPageNumPageSizeGetRequest($page_num2, $page_size2, $page_num = null, $page_size = null)
    {
        // verify the required parameter 'page_num2' is set
        if ($page_num2 === null || (is_array($page_num2) && count($page_num2) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function proV1ContentPropertiesPostRequest($create_property_command = null)
    {
        ...
        if (isset($create_property_command)) {
            $_tempBody = $create_property_command;
        }
