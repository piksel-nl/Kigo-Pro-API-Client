...
/**
 * GetPropertyDetailsPublicNameDto Class Doc Comment
 *
 * @category Class
 * @package  Piksel\KigoPro
 * @author   Patrick Leijser
 ...
 */
class GetPropertyDetailsPublicNameDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPropertyDetailsPublicNameDto';
