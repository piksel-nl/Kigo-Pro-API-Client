 ...
 * @link     https://piksel.nl
 */
class PostBookingCreditCardResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'added_payments' => '\Piksel\KigoPro\Model\PaymentResponse[]',
    ...
    {
        $this->container['added_payments'] = isset($data['added_payments']) ? $data['added_payments'] : null;
     ...
     * Gets added_payments
     *
     * @return \Piksel\KigoPro\Model\PaymentResponse[]|null
     */
     ...
     * Sets added_payments
     *
     * @param \Piksel\KigoPro\Model\PaymentResponse[]|null $added_payments Payments that were processed only for this request  We stop at the first process error, so this will include all successful and at most 1 failed payment attempt
     *
     * @return $this
     */
