...
/**
 * ScheduledTransactionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ScheduledTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduledTransactionRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['scheduled_date'] = $data['scheduled_date'] ?? null;
    }
     ...
     * Sets scheduled_date
     *
     * @param \DateTime|null $scheduled_date If PaymentCollectionMode is VirtualCC then the money will be released on this date.  So we have to schedule the transaction to this date or fall back to the payment plan if it's not provided.
     *
     * @return self
     */
