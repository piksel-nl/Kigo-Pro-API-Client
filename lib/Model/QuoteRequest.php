...
class QuoteRequest implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['compute_default_plan_only'] = isset($data['compute_default_plan_only']) ? $data['compute_default_plan_only'] : null;
        $this->container['requested_optional_fees'] = isset($data['requested_optional_fees']) ? $data['requested_optional_fees'] : null;
        $this->container['lead_guid'] = isset($data['lead_guid']) ? $data['lead_guid'] : null;
    }
