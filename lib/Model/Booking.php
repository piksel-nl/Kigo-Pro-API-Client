...
class Booking implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'statement' => '\Piksel\KigoPro\Model\GuestStatement',
        'deposits' => '\Piksel\KigoPro\Model\DepositStatement',
        'deposit_schedule' => '\Piksel\KigoPro\Model\ScheduledTransaction[]',
        'payments' => '\Piksel\KigoPro\Model\Transaction[]',
        'accepted_payment_methods' => 'string[]',
        'payment_schedule' => '\Piksel\KigoPro\Model\PaymentSchedule',
        'cancellation_policy' => '\Piksel\KigoPro\Model\CancellationPolicy',
        ...
        'payment_gateway' => '\Piksel\KigoPro\Model\PaymentGateway'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['booked_on_date'] = isset($data['booked_on_date']) ? $data['booked_on_date'] : null;
        ...
        $this->container['originating_channel_connection_id'] = isset($data['originating_channel_connection_id']) ? $data['originating_channel_connection_id'] : null;
        ...
        $this->container['cancellation_source'] = isset($data['cancellation_source']) ? $data['cancellation_source'] : null;
        $this->container['cancelled_by_role'] = isset($data['cancelled_by_role']) ? $data['cancelled_by_role'] : null;
        $this->container['cancelled_by_user_id'] = isset($data['cancelled_by_user_id']) ? $data['cancelled_by_user_id'] : null;
        ...
        $this->container['channel_collected'] = isset($data['channel_collected']) ? $data['channel_collected'] : null;
        $this->container['payment_collection_mode'] = isset($data['payment_collection_mode']) ? $data['payment_collection_mode'] : null;
        $this->container['past_due_scheduled_installment_amount'] = isset($data['past_due_scheduled_installment_amount']) ? $data['past_due_scheduled_installment_amount'] : null;
        $this->container['past_due_initiated_payments'] = isset($data['past_due_initiated_payments']) ? $data['past_due_initiated_payments'] : null;
        $this->container['past_due_scheduled_deposit_amount'] = isset($data['past_due_scheduled_deposit_amount']) ? $data['past_due_scheduled_deposit_amount'] : null;
        $this->container['past_due_scheduled_amount'] = isset($data['past_due_scheduled_amount']) ? $data['past_due_scheduled_amount'] : null;
        $this->container['credit_card'] = isset($data['credit_card']) ? $data['credit_card'] : null;
        $this->container['booking_source_code'] = isset($data['booking_source_code']) ? $data['booking_source_code'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['short_code']) && !in_array($this->container['short_code'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'short_code', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['cancellation_source']) && !in_array($this->container['cancellation_source'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'cancellation_source', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['cancelled_by_role']) && !in_array($this->container['cancelled_by_role'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'cancelled_by_role', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets statement
     *
     * @return \Piksel\KigoPro\Model\GuestStatement|null
     */
     ...
     * Sets statement
     *
     * @param \Piksel\KigoPro\Model\GuestStatement|null $statement statement
     *
     * @return $this
     */
     ...
     * Gets deposits
     *
     * @return \Piksel\KigoPro\Model\DepositStatement|null
     */
     ...
     * Sets deposits
     *
     * @param \Piksel\KigoPro\Model\DepositStatement|null $deposits deposits
     *
     * @return $this
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\ScheduledTransaction[]|null $deposit_schedule A collection of refundable payments
     *
     * @return $this
     */
     ...
     * Sets payments
     *
     * @param \Piksel\KigoPro\Model\Transaction[]|null $payments Paid Transactions and Scheduled Payments
     *
     * @return $this
     */
     ...
     *
     * @return \Piksel\KigoPro\Model\PaymentSchedule|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\PaymentSchedule|null $payment_schedule payment_schedule
     *
     * @return $this
     */
     ...
     *
     * @return \Piksel\KigoPro\Model\CancellationPolicy|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\CancellationPolicy|null $cancellation_policy cancellation_policy
     *
     * @return $this
     */
     ...
     *
     * @return \Piksel\KigoPro\Model\PaymentGateway|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\PaymentGateway|null $payment_gateway payment_gateway
     *
     * @return $this
     */
