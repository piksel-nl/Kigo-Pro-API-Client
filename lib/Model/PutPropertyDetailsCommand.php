...
/**
 * PutPropertyDetailsCommand Class Doc Comment
 *
 * @category Class
 * @package  Piksel\KigoPro
 * @author   Patrick Leijser
 * @link     https://piksel.nl
 */
class PutPropertyDetailsCommand implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutPropertyDetailsCommand';
    ...
    protected static $openAPITypes = [
        'property_names' => '\Piksel\KigoPro\Model\PutPropertyDetailsPublicNameDto[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['size_amount'] = isset($data['size_amount']) ? $data['size_amount'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['size_unit']) && !in_array($this->container['size_unit'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'size_unit', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets property_names
     *
     * @return \Piksel\KigoPro\Model\PutPropertyDetailsPublicNameDto[]|null
     */
     ...
     * Sets property_names
     *
     * @param \Piksel\KigoPro\Model\PutPropertyDetailsPublicNameDto[]|null $property_names property_names
     *
     * @return $this
     */
