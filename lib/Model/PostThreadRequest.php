 ...
 * @link     https://piksel.nl
 */
class PostThreadRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['thread_external_key'] = isset($data['thread_external_key']) ? $data['thread_external_key'] : null;
        $this->container['channel_connection_id'] = isset($data['channel_connection_id']) ? $data['channel_connection_id'] : null;
        ...
        $this->container['location_booking_id'] = isset($data['location_booking_id']) ? $data['location_booking_id'] : null;
        $this->container['deadline_for_response'] = isset($data['deadline_for_response']) ? $data['deadline_for_response'] : null;
        $this->container['guest_external_key'] = isset($data['guest_external_key']) ? $data['guest_external_key'] : null;
        $this->container['guest_first_name'] = isset($data['guest_first_name']) ? $data['guest_first_name'] : null;
        $this->container['guest_last_name'] = isset($data['guest_last_name']) ? $data['guest_last_name'] : null;
        $this->container['guest_email'] = isset($data['guest_email']) ? $data['guest_email'] : null;
        $this->container['guest_locale'] = isset($data['guest_locale']) ? $data['guest_locale'] : null;
        $this->container['guest_location'] = isset($data['guest_location']) ? $data['guest_location'] : null;
        $this->container['guest_user_id'] = isset($data['guest_user_id']) ? $data['guest_user_id'] : null;
