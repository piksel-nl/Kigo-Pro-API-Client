 ...
 * @link     https://piksel.nl
 */
class StaySettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'booking_window_rule' => '\Piksel\KigoPro\Model\ListingBookingWindowRule',
        'max_stay_rule' => '\Piksel\KigoPro\Model\ListingMaxStayRule',
        'time_between_reservations_rule' => '\Piksel\KigoPro\Model\TimeBetweenReservationsRule',
        'rate_adjustment' => '\Piksel\KigoPro\Model\ListingRateAdjustment'
    ];
    ...
    {
        $this->container['booking_window_rule'] = isset($data['booking_window_rule']) ? $data['booking_window_rule'] : null;
        $this->container['max_stay_rule'] = isset($data['max_stay_rule']) ? $data['max_stay_rule'] : null;
        $this->container['time_between_reservations_rule'] = isset($data['time_between_reservations_rule']) ? $data['time_between_reservations_rule'] : null;
        $this->container['rate_adjustment'] = isset($data['rate_adjustment']) ? $data['rate_adjustment'] : null;
    }
     ...
     *
     * @return \Piksel\KigoPro\Model\ListingBookingWindowRule|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\ListingBookingWindowRule|null $booking_window_rule booking_window_rule
     *
     * @return $this
     */
     ...
     * Gets max_stay_rule
     *
     * @return \Piksel\KigoPro\Model\ListingMaxStayRule|null
     */
     ...
     * Sets max_stay_rule
     *
     * @param \Piksel\KigoPro\Model\ListingMaxStayRule|null $max_stay_rule max_stay_rule
     *
     * @return $this
     */
     ...
     *
     * @return \Piksel\KigoPro\Model\TimeBetweenReservationsRule|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\TimeBetweenReservationsRule|null $time_between_reservations_rule time_between_reservations_rule
     *
     * @return $this
     */
     ...
     *
     * @return \Piksel\KigoPro\Model\ListingRateAdjustment|null
     */
     ...
     *
     * @param \Piksel\KigoPro\Model\ListingRateAdjustment|null $rate_adjustment rate_adjustment
     *
     * @return $this
     */
