...
/**
 * PutHouseRulesCommand Class Doc Comment
 *
 * @category Class
 * @package  Piksel\KigoPro
 * @author   Patrick Leijser
 ...
 */
class PutHouseRulesCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutHouseRulesCommand';
    ...
    {
        $this->container['smoking_allowed'] = $data['smoking_allowed'] ?? null;
        $this->container['kids_allowed'] = $data['kids_allowed'] ?? null;
        $this->container['family_friendly'] = $data['family_friendly'] ?? null;
        $this->container['pets_allowed'] = $data['pets_allowed'] ?? null;
        $this->container['parties_and_events_allowed'] = $data['parties_and_events_allowed'] ?? null;
    }
