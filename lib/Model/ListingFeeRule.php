 ...
 * @link     https://piksel.nl
 */
class ListingFeeRule implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rate_value'] = isset($data['rate_value']) ? $data['rate_value'] : null;
        $this->container['is_mandatory'] = isset($data['is_mandatory']) ? $data['is_mandatory'] : null;
        $this->container['guest_range_min'] = isset($data['guest_range_min']) ? $data['guest_range_min'] : null;
        $this->container['guest_range_max'] = isset($data['guest_range_max']) ? $data['guest_range_max'] : null;
        $this->container['los_min'] = isset($data['los_min']) ? $data['los_min'] : null;
        $this->container['los_max'] = isset($data['los_max']) ? $data['los_max'] : null;
        ...
        $this->container['is_commissionable'] = isset($data['is_commissionable']) ? $data['is_commissionable'] : null;
        $this->container['is_taxable'] = isset($data['is_taxable']) ? $data['is_taxable'] : null;
        $this->container['type_application'] = isset($data['type_application']) ? $data['type_application'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['calculation_mode']) && !in_array($this->container['calculation_mode'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'calculation_mode', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['type_application']) && !in_array($this->container['type_application'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'type_application', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
