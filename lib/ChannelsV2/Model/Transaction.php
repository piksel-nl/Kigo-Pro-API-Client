...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['accounting_category'] = $data['accounting_category'] ?? null;
        $this->container['payment_method_type'] = $data['payment_method_type'] ?? null;
        $this->container['accounting_type'] = $data['accounting_type'] ?? null;
        ...
        $this->container['schedule_transaction_id'] = $data['schedule_transaction_id'] ?? null;
        $this->container['is_past_due'] = $data['is_past_due'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['accounting_category']) && !in_array($this->container['accounting_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'accounting_category', must be one of '%s'",
                $this->container['accounting_category'],
                implode("', '", $allowedValues)
            );
        }
        ...
        if (!is_null($this->container['accounting_type']) && !in_array($this->container['accounting_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'accounting_type', must be one of '%s'",
                $this->container['accounting_type'],
                implode("', '", $allowedValues)
            );
        }
