...
class PropertyApi
{
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm, HTTP status code, HTTP response headers (array of strings)
     */
    public function proV1ContentPropertiesIdPropertysummaryGetWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\GetPropertySummaryVm',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Piksel\Kigo\ChannelsV2\Model\CreatePropertyCommand $create_property_command create_property_command (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope
     */
     ...
     *
     * @param  \Piksel\Kigo\ChannelsV2\Model\CreatePropertyCommand $create_property_command (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope, HTTP status code, HTTP response headers (array of strings)
     */
    public function proV1ContentPropertiesPostWithHttpInfo($create_property_command = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\CreatePropertyResponseVmCommandOkEnvelope',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
