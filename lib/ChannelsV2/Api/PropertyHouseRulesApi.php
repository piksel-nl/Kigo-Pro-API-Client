...
class PropertyHouseRulesApi
{
     ...
     * @return \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ValidationErrorException|\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm, HTTP status code, HTTP response headers (array of strings)
     */
    public function proV1ContentPropertiesIdHouserulesGetWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\GetHouseRulesVm',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id id (required)
     * @param  \Piksel\Kigo\ChannelsV2\Model\PutHouseRulesCommand $put_house_rules_command put_house_rules_command (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $id (required)
     * @param  \Piksel\Kigo\ChannelsV2\Model\PutHouseRulesCommand $put_house_rules_command (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
