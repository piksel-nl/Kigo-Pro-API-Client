...
class ListingApi
{
     ...
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\GetDiffResult
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\GetDiffResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsDiffGetWithHttpInfo($modified_after, $options = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\GetDiffResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\GetDiffResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\GetDiffResult';
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\GetDiffResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsGetWithHttpInfo($cc_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\GetListingsResultListResourceList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsIdAvailabilityGetWithHttpInfo($id, $start_date, $end_date)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\AvailabilityResource',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsIdCheckavailabilityGetWithHttpInfo($id, $check_in_date, $check_out_date, $num_adults, $num_children = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\CheckAvailabilityOutputResource',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ListingResource
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ListingResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsIdGetWithHttpInfo($id, $options = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\ListingResource' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\ListingResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\ListingResource';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\ListingResource',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\ApiError|\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource, HTTP status code, HTTP response headers (array of strings)
     */
    public function channelsV2ListingsIdRatesGetWithHttpInfo($id, $start_date, $end_date, $payment_plan_guid = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\RateScheduleResource',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
