...
class RateApi
{
     ...
     * @return \Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[]
     */
     ...
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[], HTTP status code, HTTP response headers (array of strings)
     */
    public function proV1PropertiesIdRatesGetWithHttpInfo($id, $start_date = null, $end_date = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Piksel\Kigo\ChannelsV2\Model\GetPropertyRateVm[]',
     ...
     *
     * @param  int $id id (required)
     * @param  \Piksel\Kigo\ChannelsV2\Model\SetPropertyRateDto[] $set_property_rate_dto set_property_rate_dto (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  int $id (required)
     * @param  \Piksel\Kigo\ChannelsV2\Model\SetPropertyRateDto[] $set_property_rate_dto (optional)
     *
     * @throws \Piksel\Kigo\ChannelsV2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
